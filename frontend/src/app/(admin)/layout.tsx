        ...
        <aside className={`admin-sidebar ${isSidebarOpen ? "is-open" : ""}`}>
          ...
          <div className="admin-sidebar-footer">
             <div className="admin-user-pill">
                ...
                <div>
                   <div style={{ fontWeight: 'bold', fontSize: '0.9rem', color: 'var(--text-color)' }}>{user.full_name}</div>
                   <div style={{ fontSize: '0.75rem', color: textMuted, overflowWrap: "anywhere" }}>{user.email}</div>
                </div>
             </div>
          </div>
        </aside>
